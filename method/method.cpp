...
QSharedPointer<Method> Method::getMethod(int id)
{
    ...
    case 19024: {
        unsigned char ch[] = {0xe4, 0xb8, 0xb4, 0xe9, 0x98, 0xb5, 0xe7, 0xaa, 0x81, 0xe8, 0xa2, 0xad};
        Logger::H().printname(ch, sizeof(ch), id);
        method = QSharedPointer<Method0019024>::create();
    } break;
    case 19124: {
        unsigned char ch[] = {0xe4, 0xb9, 0xb1, 0xe6, 0x95, 0x8c, 0xe6, 0x96, 0xb9, 0xe9, 0x98, 0xb5};
        Logger::H().printname(ch, sizeof(ch), id);
        method = QSharedPointer<Method0019124>::create();
    } break;
    case 19224: {
        unsigned char ch[] = {0xe5, 0xa5, 0x87, 0xe8, 0xae, 0xa1, 0xe8, 0xbf, 0xad, 0xe5, 0x87, 0xba};
        Logger::H().printname(ch, sizeof(ch), id);
        method = QSharedPointer<Method0019224>::create();
    } break;
    case 19324: {
        unsigned char ch[] = {0xe5, 0xa4, 0x9c, 0xe8, 0xa2, 0xad};
        Logger::H().printname(ch, sizeof(ch), id);
        method = QSharedPointer<Method0019324>::create();
    } break;
    case 20120: {
    ...
    case 170121: {
        unsigned char ch[] = {0xe4, 0xbf, 0x9d, 0xe5, 0xa2, 0x83, 0xe5, 0xae, 0x89, 0xe6, 0xb0, 0x91};
        Logger::H().printname(ch, sizeof(ch), id);
        method = QSharedPointer<Method0170121>::create();
    } break;
    case 170221: {
        unsigned char ch[] = {0xe9, 0x9a, 0x8f, 0xe6, 0x9c, 0xba, 0xe5, 0xba, 0x94, 0xe5, 0x8f, 0x98};
        Logger::H().printname(ch, sizeof(ch), id);
        method = QSharedPointer<Method0170221>::create();
    } break;
// insert case
    case 1010121: {
    ...
    case 1170121: {
        ...
        Logger::H().printname(ch, sizeof(ch), id);
        method = QSharedPointer<Method1170121>::create();
    } break;
// insert item case 1
    case 2010121: {
    ...
    case 2170221: {
        unsigned char ch[] = {0xe6, 0x97, 0xa0, 0xe5, 0xbd, 0x93, 0xe9, 0xa3, 0x9e, 0xe5, 0x86, 0x9b};
        Logger::H().printname(ch, sizeof(ch), id);
        method = QSharedPointer<Method2170221>::create();
    } break;
// insert item case 2
    case 3010121: {
