...
int Method0070124::run(Ground* ground, Item* item1)
{
    ...
    int obj = item1->g[0];
    QSharedPointer<Buff> buff = QSharedPointer<Buff>(new Buff0070124(item1->g[0], obj, id));
