...
void Buff022::enter(Ground* ground)
{
...
void Buff022::exit(Ground* ground)
{
...
void Buff022::update(Ground* ground, QSharedPointer<Buff> buff)
{
...
void Buff022::run(Ground* ground)
{
